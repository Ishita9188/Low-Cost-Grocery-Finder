 ...
 * @author ADMIN
 */
@WebServlet(urlPatterns = {"/Register_Action"})
public class Register_Action extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try 
		{
		    ...
		    PreparedStatement query=con.prepareStatement("insert into register(name,pass,mail,dob,gender,profile,cont,address)values ('"+m.get(0)+"','"+m.get(1)+"','"+m.get(2)+"','"+m.get(3)+"','"+m.get(4)+"','"+ms.get(0)+"','"+m.get(5)+"','"+m.get(6)+"')");
