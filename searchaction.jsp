  ...
  <div class="header-container">
    ...
    <div class="hero-slider owl-carousel">
        <div class="hs-item">
            ...
            <h1 align="center" style="font-size: larger; font-weight: bold; margin-top: 115px; color: #c70707;">
                View All Shopping items by <%=search%>
            </h1><br><br>
            ...
            <div class="scroll-container" >
                <table>
                    ...
                    <%
                        ...
                        PreparedStatement query1 = con.prepareStatement("SELECT * FROM dataset where place=?");
                    ...
                    <tr style="font-size: 15px; color: black;">
                        ...
                        <td><img src="SHOP/<%=image%>" alt="" style="width:180px; height:100px;"></td>
                        ...
                        <td>
                            <a href="carts.jsp?id=<%=rs.getString("resid")%>&&image=<%=rs.getString("image")%>&&pid=<%=rs.getString("pid")%>&&pname=<%=rs.getString("pname")%>&&cost=<%=rs.getString("rate")%>&&place=<%=rs.getString("place")%>"
                               class="site-btn btn-line" style="background-color: green;">ADD TO CART</a>
                        </td>
                    </tr>
