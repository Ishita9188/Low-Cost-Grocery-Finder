...
<body>
	...
	<section class="hero-section set-bg" data-setbg="img/bg1.jpg" style="background-repeat: no-repeat;background-attachment: fixed;background-size:100% 100%;">
        ...
        <form action="Login_Action">
            ...
            <tr>
                ...
                <td width="60%">
                    <table border="0" cellspacing="10" cellpadding="15" bgcolor="white" width="40%" style="margin-top:100px;">
                        <tr><td colspan="2" style="text-align:center;color:white;padding:20px;font-size: 30px;background-color: black">User Login</td></tr>
                        <tr height="30px"></tr>
          ...
          <tr><td align="center" colspan="2"><a href="Register.jsp">Register Now!</a></td></tr>
                    </table>
                </td>
            </tr>
